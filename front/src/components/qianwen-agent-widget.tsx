        ...
        <DialogPrimitive.Portal>
          ...
          >
              ...
              {chat.map((m) => (
                <div
                  ...
                  className={cn(
                    ...
                    m.role === "user" ? "bg-background/40 border-border/70" : "bg-background/20 border-border/60"
                  )}
                >
            ...
            <div className="p-4 border-t border-border/60 space-y-2">
              ...
              <div className="flex items-center gap-2">
                <div className="text-[11px] text-muted-foreground flex-1">提示：先在左侧选择时间戳，智能体建议会更精准。</div>
                <Button
                  type="button"
                  onClick={submit}
                  disabled={loading || !input.trim()}
